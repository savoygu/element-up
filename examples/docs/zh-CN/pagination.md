...
<div class="block">
  ...
  <up-pagination layout="prev, pager, next" :total="50"> </up-pagination>
</div>
<div class="block">
  <span class="demonstration">大于 7 页时的效果</span>
  <up-pagination layout="prev, pager, next" :total="1000"> </up-pagination>
</div>
```
...
```html
<up-pagination background layout="prev, pager, next" :total="1000">
</up-pagination>
```
...
```html
<up-pagination small layout="prev, pager, next" :total="50"> </up-pagination>
```
