...
:::tip
组件书写形式发生变化：`<el-cascader>`修改为`<up-cascader>`，`<el-cascader-panel>`修改为`<up-cascader-panel>`
:::
...
<div class="block">
  ...
  <up-cascader
    v-model="value"
    :options="options"
    @change="handleChange"></up-cascader>
</div>
<div class="block">
...
```html
<up-cascader :options="options"></up-cascader>
...
:::demo
```html
<up-cascader :options="options" clearable></up-cascader>
...
```html
<up-cascader :options="options" :show-all-levels="false"></up-cascader>
...
```html
<up-cascader :props="props"></up-cascader>
...
```html
<up-cascader-panel :options="options"></up-cascader-panel>
