...
<template>
  <div class="block">
    ...
    <up-carousel height="150px">
      <up-carousel-item v-for="item in 4" :key="item">
  ...
  <div class="block">
    ...
    <up-carousel trigger="click" height="150px">
      <up-carousel-item v-for="item in 4" :key="item">
        <h3 class="small">{{ item }}</h3>
      </up-carousel-item>
    </up-carousel>
...
```html
<template>
  <up-carousel indicator-position="outside">
    <up-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </up-carousel-item>
  </up-carousel>
...
```html
<template>
  <up-carousel :interval="5000" arrow="always">
    <up-carousel-item v-for="item in 4" :key="item">
      <h3>{{ item }}</h3>
    </up-carousel-item>
  </up-carousel>
...
```html
<template>
  <up-carousel :interval="4000" type="card" height="200px">
    <up-carousel-item v-for="item in 6" :key="item">
...
```html
<template>
  <up-carousel height="200px" direction="vertical" :autoplay="false">
    <up-carousel-item v-for="item in 3" :key="item">
      <h3 class="medium">{{ item }}</h3>
    </up-carousel-item>
  </up-carousel>
...
:::demo 通过 props `data` 和 slot `up:item`，可以实现自定义 item 的内容。

```html
<template>
  <up-carousel :data="data">
    <div slot="up:item" slot-scope="{ item }">
      <h2>{{item.title}}</h2>
      <img :src="item.imgUrl" />
    </div>
  </up-carousel>
